...
import LuckyBox from "./GameList/LuckyBox";
import LuckyCard from "./GameList/LuckyCard";
import LuckyWheel from "./GameList/LuckyWheel";
import BuyGamepassHistory from "./Profile/History/BuyGamepassHistory";
...
import WithdrawRobux from "./Profile/Withdraw/WithdrawRobux";


export {
    LuckyBox as LuckyBoxPage,
    LuckyCard as LuckyCardPage,
    LuckyWheel as LuckyWheelPage,
    Login as LoginPage,
    Register as RegisterPage,
    Profile as ProfilePage,
    Recharge as RechargePage,
    BuyRobux as BuyRobuxPage,
    WithdrawRobux as WithdrawRobuxPage,
    BuyGamepassHistory as BuyGamepassHistoryPage,
